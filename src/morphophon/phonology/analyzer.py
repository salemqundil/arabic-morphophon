...
def analyze_phonemes(text):
    ...
    for char in text:
        if char in ARABIC_CONSONANTS:
            ...
            phoneme_data = ARABIC_VOWELS[char].copy()  # type: ignore
...
def get_consonant_type(char):
    """
    Get the type of consonant (end, fricative, etc.)
