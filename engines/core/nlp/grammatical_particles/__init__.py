...
"""
محرك تحليل الجسيمات النحوية العربية,
    GrammaticalParticlesEngine Package
"""

from .engine import GrammaticalParticlesEngine  # noqa: F401,
    __all__ = ['GrammaticalParticlesEngine']
