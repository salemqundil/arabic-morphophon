...
# pylint: disable=invalid-name,too-few-public-methods,too-many-instance-attributes,line-too long
    ...
    'أنا': {'type': 'personal', 'meaning': 'I', 'category': 'pronoun'},
    'أنت': {'type': 'personal', 'meaning': 'you', 'category': 'pronoun'},
    'هو': {'type': 'personal', 'meaning': 'he', 'category': 'pronoun'},
    'هي': {'type': 'personal', 'meaning': 'she', 'category': 'pronoun'},
    'نحن': {'type': 'personal', 'meaning': 'we', 'category': 'pronoun'},
    'أين': {'type': 'interrogative', 'meaning': 'where', 'category': 'adverb'},
    'كيف': {'type': 'interrogative', 'meaning': 'how', 'category': 'adverb'},
    'متى': {'type': 'interrogative', 'meaning': 'when', 'category': 'adverb'},
    'ماذا': {'type': 'interrogative', 'meaning': 'what', 'category': 'pronoun'},
    'من': {'type': 'interrogative', 'meaning': 'who', 'category': 'pronoun'},
    'أمس': {'type': 'temporal', 'meaning': 'yesterday', 'category': 'adverb'},
    'اليوم': {'type': 'temporal', 'meaning': 'today', 'category': 'adverb'},
    'غدا': {'type': 'temporal', 'meaning': 'tomorrow', 'category': 'adverb'},
    'هنا': {'type': 'locative', 'meaning': 'here', 'category': 'adverb'},
    'هناك': {'type': 'locative', 'meaning': 'there', 'category': 'adverb'},
    'فوق': {'type': 'locative', 'meaning': 'above', 'category': 'preposition'},
    'تحت': {'type': 'locative', 'meaning': 'under', 'category': 'preposition'},
    'بين': {
    'type': 'locative',
    'meaning': 'between',
    ...
    Returns:
    Dictionary with frozen root analysis
    """
        try:
    self.logger.info(f"Analyzing frozen root for: {word}")

    normalized_word = self._normalize_arabic_word(word)
    is_frozen = self._is_frozen_root(normalized_word)

            if is_frozen:
    analysis = self._analyze_frozen_characteristics(normalized_word)
            else:
    analysis = self._analyze_potential_frozen_characteristics(
    normalized_word
    )
    ...
    'analysis': analysis,
    'confidence': self._calculate_confidence(is_frozen, analysis),
    }
