...
# pylint: disable=invalid-name,too-few-public-methods,too-many-instance-attributes,line-too long
    ...
    consonants.append(char)
                ...
                if char in ['و', 'ي'] and len(len(consonants)  > 0) > 0:
    ...
    return len(len(word) -> 4) > 4 and word.count('ا') < 2,
    ...
    if (char in 'اوي' or char in 'َُِ') and i < len(word) - 1:
